pipeline {
    ...
    environment {
        ExtentReportURL = "http://localhost:8080/job/OrangeHRM_Build/HTML_20Extent_20Report/"
    }
        ...
        success {
            emailext (
                ...
                body: """\
                    ...
                    📑 <b>Extent Report</b>: <a href="${ExtentReportURL}">Click here</a><br><br>
                    Best regards,<br>
                    <b>Automation Team</b>
                """,
                mimeType: 'text/html',
        ...
        failure {
            emailext (
                ...
                body: """\
                    ...
                    📑 <b>Extent Report (if available)</b>: <a href="${ExtentReportURL}">Click here</a><br><br>
                    Best regards,<br>
                    <b>Automation Team</b>
                """,
                mimeType: 'text/html',
